<template>
  <div class="w-full flex flex-col gap-6">
    ...
    <section class="p-6 flex flex-col gap-6 bg-slate-50 border border-slate-100 rounded-3xl shadow-3xs">
      ...
      <div class="bg-white border border-slate-100 rounded-2xl p-5 shadow-xs flex flex-col gap-4">
        ...
        <div v-if="gitCommits.length === 0" class="text-slate-400 italic text-sm py-12 text-center">
          No commit history recorded for this author.
        </div>
          ...
          >
            <div class="flex flex-col gap-1 min-w-0">
              ...
              <div class="flex flex-wrap items-center gap-2 text-[10px] text-slate-400 font-medium">
                ...
                <span v-if="commit.files_changed">•</span>
                <span v-if="commit.files_changed" class="text-slate-500">{{ commit.files_changed }} files</span>
              </div>
            </div>
