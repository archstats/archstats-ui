        ...
        <template #header>
          <div class="p-4 text-center">
            ...
            <p class="text-sm"><span class="font-mono text-xs font-bold text">{{ selectedComponent.name }}</span><br>
              is referenced
              <span class="text-tertiary-500 font-semibold">{{ totalReferencesAfferent }}</span> times in  <span class="text-tertiary-500 font-semibold">{{ selectedComponent[store.statName("modularity__coupling__afferent")] }}</span> files by <span
        ...
        <template #header>
          <div class="p-4 text-center">
            ...
            <p class="text-sm">
              ...
              <span class="text-secondary-500 font-semibold">{{ totalReferencesEfferent }}</span> references in <span class="text-secondary-500 font-semibold">{{selectedComponent[store.statName("modularity__coupling__efferent")]}}</span> files to <span
