<template>
  <div class="container">
    <div class="my-36 ">
      <h1 class="text-5xl mb-12 font-bold text-archstats-500">Archstat Views</h1>
      ...
      <ul class="mb-12 pl-8">
        <li class="mb-2"><span class="font-bold text-archstats-600 ">Tree View</span> - A recursive view that<span
            class="font-semibold">&mdash;per directory&mdash;</span>shows where your stats are.
        </li>
        <li class="mb-2"><span class="font-bold text-archstats-600 ">Connections View</span> - An interactive diagram that
          shows the amount of coupling between allComponents, along with a allComponents relative size.
        </li>
        <li class="mb-2"><span class="font-bold text-archstats-600 ">Table View</span> - All stats presented in an
          indexed,
          user-friendly manner.
        </li>
        <li class="mb-2"><span class="font-bold text-archstats-600 ">Summary View</span> - All stats presented in a
          summarized<span
              class="font-semibold">&mdash;at glance&mdash;</span>manner.
        </li>
        <li class="mb-2"><span class="font-bold text-archstats-600 ">Root View</span> - Shows a list of allComponents that
          are extended by other allComponents and their orphaned classes.
        </li>
        <li class="mb-2"><span class="font-bold text-archstats-600 ">Similarity View</span> - A UI that shows the
          similarity between allComponents.
        </li>
      </ul>
      <p class="mb-12">Archstat Views depends on the the output of <code
          class="bg-archstats-100 text-archstats-700 text-sm  py-2 px-2 rounded"><span
