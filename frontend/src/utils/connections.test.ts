...
describe("URL state round-trip", () => {
  ...
  it("round-trips every field", () => {
    const state: ConnectionsQueryState = { rep: "crosscut", source: "git", level: "files", by: "Domain", color: "Layer", x: "Team", measure: "files", cycles: "selected", order: "levels", relation: "no-import", minShared: 10, minRate: 0.3, period: "90", q: "dto", sel: "a" }
