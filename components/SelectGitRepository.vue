  ...
  <Teleport to="body">
    <div
      ...
      <div class=" p-16 bg-white h-fit box-border w-1/2 mt-36 rounded" @click.stop>
        <h1 class="text-3xl mb-8 font-bold text-archstats-tertiary-500">Select Git Repository</h1>
        ...
        <div class="mt-12 grid grid-cols-3 gap-8 mb-12">
          ...
          <input v-model="repo"
                 class="col-span-2 p-2 box-border bg-gray-100 border-archstats-tertiary-400 rounded border-2 outline-archstats-tertiary-700"
          ...
          <div class="flex self-center col-span-2">
            <div v-for="selection in availableSelections" class="mr-6 flex ">
              <input type="checkbox" :value="selection.value"
                     v-model="selections"
                     class="p-2 box-border bg-gray-100 border-archstats-tertiary-400 rounded border-2 outline-archstats-tertiary-700 mr-2">
