<template>
  <LongHover :time="1300">
    <template #main-content>
      <button class="border-tertiary-500 border bg-tertiary-50 px-4 py-2 rounded-full cursor-pointer" @click.prevent="open = true">
        ...
        <Teleport v-if="open" to="body">
          <div v-if="open" class="fixed z-100 h-screen bg-gray-700 bg-opacity-50 w-screen top-0 left-0 flex items-center justify-center" >
            ...
            <div class="w-2/3 p-8 bg-white rounded-md mt-12 shadow-xl h-fit" v-click-outside = "toggleOff">
              <h1 class="text-xl text-tertiary-500  font-bold">Editing current scope</h1>
