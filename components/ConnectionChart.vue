<template>
  <div class="chart-container">
    <div class="text-gray-700 w-1/2">
      <h2 class="text-3xl mb-4 font-bold text-archstats-500">Coupling View</h2>
      <p class=" mb-4 text-gray-700">The Coupling View depicts the following: </p>
      <ul class="mb-12 pl-8 flex flex-col gap-4">
        <li><span class="text-archstats-500 font-bold">Efferent and Afferent Couplings</span> between components. The connection flows in the direction of the arrow. The
          amount of connections between components is represented in the attraction between components, and the
          thickness of lines.
        </li>
        <li><span class="text-archstats-500 font-bold">Component Size</span> relative to other components. The relative size is configurable.</li>
      </ul>
    </div>
    ...
    <div class="mb-4 flex gap-16 ">
      ...
      <div class="">
        ...
        <input type="number" v-model="maxConnections"
               class="p-2 box-border bg-gray-100 border-archstats-400 w-20 rounded border-2 outline-archstats-700">
      </div>
      <div>
    ...
    <div :id="chartId" ref="chart" class="border-2 border-archstats-400"></div>
