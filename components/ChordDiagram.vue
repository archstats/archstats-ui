<template>
  <div class="">
    ...
    <ul>
      <li class="mb-2">
        The <span class="text-archstats-secondary-500 font-semibold">efferent couplings</span> or <span class="italic text-archstats-secondary-500">dependencies / outgoing connections</span>
      ...
      <li class="mt-2">
        The <span class="text-archstats-tertiary-500 font-semibold">afferent couplings</span> or <span class="italic text-archstats-tertiary-500">dependents / incoming connections</span>
    ...
    <div :id="chartId" ref="chart" class="border-2 border-archstats-tertiary-400 mt-12 w-[900px]"></div>
  </div>
