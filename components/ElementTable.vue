  ...
  <div class="w-full overflow-x-scroll">
    <table class="mb-4">
      ...
      <tr>
        ...
        <th class="py-1 px-2 text-left cursor-pointer hover:text-sky-500" @click="toggleSort('name')">Name <span
            v-if="sortSettings.column === 'name'"
            v-html="sortSettings.ascending ? '&#8593':'&#8595'"></span>
        </th>
        <th class="py-1 px-2 cursor-pointer cursor-pointer hover:text-sky-500 text-left" v-for="column in columns"
      ...
      <tbody>
      <tr v-for="element in pageOfElements" class="hover:bg-sky-50" :class="{'cursor-pointer': clickableElements}"
